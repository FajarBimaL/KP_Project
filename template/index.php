...
if(isset($_SESSION["id_user"])){
  $user = $log->userSelected($_SESSION["id_user"]);
}
else {
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="index.php"><img class="mt-3 ml-3" style="height: 65px;" src="images/phapros.png" alt="logo"/></a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end primary">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <!-- <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a href="./pages/login.php"><button class="dropdown-item preview-item">Logout</button></a> -->
            </div>
          </li>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Riwayat Dokumen</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="?page=riwayat_masuk">Riwayat Masuk</a></li>
                <li class="nav-item"> <a class="nav-link" href="?page=riwayat_keluar">Riwayat Keluar</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=dokumen_masuk">
              <i class="typcn typcn-document-text menu-icon"></i>
              <span class="menu-title">Dokumen Masuk</span>
              <!-- <i class="menu-arrow"></i> -->
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=dokumentasi">
              <i class="typcn typcn-document-text menu-icon"></i>
              <span class="menu-title">Dokumen Keluar</span>
              <!-- <i class="menu-arrow"></i> -->
            </a>
            <!-- <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="index.php?page=buat_dokumen">
              <i class="typcn typcn-film menu-icon"></i>
              <span class="menu-title">Buat dokumen</span>
            </a>
          </li> -->
          <!-- <li class="nav-item">
